        ...
        <div class="col-lg-12">
            <div class="card box-shadow-0">
                <div class="card-header border-bottom">
                    <h4 class="card-title">Add Package Category</h4>
                </div>
                <div class="card-body">
                    <p class="text-primary">{{session('message')}}</p>

                    <form action="{{route('package.category.save')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="package_category" class="form-label mb-3">Package Category Name</label>
                                <input type="text" class="form-control border-warning" placeholder="Enter Category Name" name="package_category_name">
