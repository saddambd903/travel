@extends('layouts.app')
@section('title', 'Create Tour Facility')
@section('body')
        ...
        <div class="col-lg-12">
            <div class="card box-shadow-0">
                <div class="card-header border-bottom">
                    <h4 class="card-title">Add Tour Facilities</h4>
                </div>
                <div class="card-body">
                    <p class="text-primary">{{session('message')}}</p>

                    <form action="{{route('tour.facility.save')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="tour_facility" class="form-label mb-3">Tour Facility Name</label>
                                <input type="text" class="form-control border-warning" placeholder="Enter Facility Name" name="tour_facility_name">
