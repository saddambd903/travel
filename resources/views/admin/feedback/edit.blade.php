                    ...
                    <form action="{{route('feedback.update', ['id' => $feedback->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control border-secondary" placeholder="Enter Place Name" value="{{$feedback->client_name}}" name="client_name">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="guest_count" class="form-label mb-3">Client Designation</label>
                                <input type="text" class="form-control border-secondary" placeholder="Enter client designation" value="{{$feedback->client_designation}}" name="client_designation">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    <img src="{{asset($feedback->client_image)}}" class="" height="80">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <textarea class="form-control border-warning" name="client_description" rows="4" placeholder="Type Here">{{$feedback->client_description}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
