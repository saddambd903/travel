                    ...
                    <form action="{{route('client.save')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control border-secondary" id="exampleInputEmail2" placeholder="Enter Client Name" name="client_name" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="client_rating" class="form-label mb-3">Client Rating</label>
                                <input type="number" class="form-control border-secondary" id="client_rating" placeholder="Enter Client Rating" name="client_rating" required>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="card-body">
                                    <textarea name="client_description" placeholder="Type Here">{{old("client_description")}}</textarea>
                                </div>
